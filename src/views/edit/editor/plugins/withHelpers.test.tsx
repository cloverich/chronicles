...
describe("links", function () {
  ...
  describe("viewing link", function () {
    it(
      "displays a pop-up view menu when a link (and only a link) is focused or highlighted",
    );
  ...
  describe("existing link", function () {
    ...
    it(
      "lets you modify an existing link when clicking edit, saving updates the link",
    );
