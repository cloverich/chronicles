...
export function CodeBlockElement(props: PlateElementProps<TCodeBlockElement>) {
  ...
  return (
    <PlateElement
      className="mb-8 w-full max-w-[var(--max-w-code)] py-1 **:[.hljs-emphasis]:italic **:[.hljs-section]:font-bold **:[.hljs-strong]:font-bold"
      {...props}
    >
...
function CodeBlockCombobox() {
  ...
  const value: string = element.lang || "plaintext";
