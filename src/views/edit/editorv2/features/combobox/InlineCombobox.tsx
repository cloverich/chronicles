...
const InlineCombobox = ({
  ...
  const { props: inputProps, removeInput } = useComboboxInput({
    ...
    // NOTE: Super confusing but... clicking an item in the dropdown fires the blur
    // event (on this input) first. Avoid canceling to avoid inserting the search
    // text before the click event handler fires (which inserts e.g. a note link).
    // Note that a `deselect` cause by clicking outside the combobox will still trigger
    // onCancelInput (leaving text, expected), but I'm not sure what the mechanism is?
