    ...
    <Pane>
      ...
      <Pane marginTop={24}>
        <div className={css`display: flex; justify-content: flex-start;`}>
          <div className={css`margin-right: 4px;`}>{placeholderDate}/</div>
          <span
            className={css`
      ...
      `}>
        ...
        <Editor saving={true} value={SlateTransformer.createEmptyNodes()} setValue={noop} />

        <Pane marginTop={24}>
          <Button onClick={noop} disabled={true} isLoading={true}>Save</Button>
        </Pane>
      </Pane>
    </Pane>
  );
