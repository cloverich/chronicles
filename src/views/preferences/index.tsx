  ...
  return (
    <Pane>
      <SettingsBox>
        ...
        <p><code>{preferences.DATABASE_URL}</code></p>
        <ul>
          ...
          <li><b>To change the files location:</b> <i>First</i> move the existing database file to your desired location, <i>then</i> use the filepicker to select the new location</li>
