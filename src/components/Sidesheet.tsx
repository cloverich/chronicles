...
const sheetVariants = cva(
  "backdrop-blur-sm drag-none fixed z-50 gap-4 bg-secondary/80 border-accent-muted p-4 shadow-lg max-w-sm",
  {
    variants: {
      side: {
      ...
      animate: {
        yes: "transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300",
        no: "",
      },
    },
    defaultVariants: {
