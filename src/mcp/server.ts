...
class ChroniclesMcpServer {
  ...
  private clientPromise: Promise<NodeClient> | null = null;
  ...
  private handleMessage(message: unknown) {
    ...
    const request: JsonRpcRequest = message as unknown as JsonRpcRequest;
  ...
  private async getClient(): Promise<NodeClient> {
